...
| 状态 | 说明 |
|------|------|
| ❌ 已关闭，未合入 | PR #87003 于 2026-05-27 01:17 关闭，从未合并 |
| 建议 | 关注 ClawSweeper 后续修复；生产环境暂用 v2026.5.20 或等待 v2026.5.26 stable |

### 8.6 相关 Issue

| # | 标题 | 状态 |
|---|------|------|
| [#87003](https://github.com/openclaw/openclaw/pull/87003) | Codex WebChat delivery hints fix | ❌ 已关闭未合入 |
...
|------|------|----------|------|-----------|
| **v2026.5.26** | **stable (Latest)** | **2026-05-27** | ✅ 稳定 | ⚠️ 见下方 |
| v2026.5.26-beta.1 | beta | 2026-05-26 | ✅ 已晋升 | 待验证 |
| v2026.5.25-beta.1 | beta | 2026-05-25 | ✅ 已晋升 | - |
| v2026.5.24-beta.2 | beta | 2026-05-24 | ✅ 已晋升 | - |

### 9.2 版本推荐

| 场景 | 推荐版本 | 说明 |
|------|----------|------|
| **生产环境** | v2026.5.26 | **最新 stable，已晋升 Latest** |
| 体验最新功能 | v2026.5.26 | 当前 stable |
