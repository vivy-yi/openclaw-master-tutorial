...
> 核心重磅：垂直领域 Agent 开发的核心能力——如何让 AI 可靠地获取并操作特定网站/平台的数据。本章详细解析三层数据采集架构（OpenClaw 内置浏览器 → 外部 MCP/CLI/反检测浏览器 → 平台官方 API），涵盖选型决策树、Agent Reach 集成方法、合规安全规范，以及金融、内容运营等多个领域的实战工作流。

- [→ 立即阅读：22.1 垂直领域数据采集体系](22.1_垂直领域数据采集体系：浏览器+MCP+API三层架构.md)

---

## 22.2 Moltbook — AI Agent 专属社交网络
